...
#Load in the CSV
df = sqlContext.read.format("csv").option("header", "true").load("Arrest_Data_from_2010_to_Present.csv")

# List of columns to keep
keep_list = ['Arrest Date', 'Area ID', 'Sex Code', 'Descent Code']
...
print("White | Black | Hispanic")
print("{:<6}  {:<6}  {:<6}".format(countW, countB, countH))
